...
import { ChevronDownIcon, CheckIcon, ResetIcon, InfoCircledIcon, Share1Icon } from '@radix-ui/react-icons';
  ...
  return (
    <>
      <div className="bg-black/30 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-lg mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium
                       bg-accent text-black rounded-lg hover:bg-accent/80
          ...
          <div className="flex justify-between sm:justify-start items-center gap-3">
            ...
            <div className="bg-black/20 rounded-lg px-4 py-2 text-white font-medium text-xs sm:text-sm">
      ...
      <Modal
        ...
        title="Build Manager"
      >
        <BuildManager onClose={() => setIsModalOpen(false)} />
      </Modal>
    </>
  );
} 